...
class MatingAdDetails extends StatefulWidget {
  // widget.id ile id nin numarasını al
  final String id;
  const MatingAdDetails({super.key, required this.id});

  @override
  _MatingAdDetailsState createState() => _MatingAdDetailsState();
}

class _MatingAdDetailsState extends State<MatingAdDetails> {
  // Is Owner
  ...
  final String ourAnimal = "Cat";
  final String ourBreed = "Simmental";
  final String ourGender = "Male";
  final String lookingAnimal = "Cat";
  final String lookingBreed = "Simmental";
  final String lookingGender = "Male";

  // Contact Details
  final String telegram = "neasd_dasdasd_ss";
  final String email = "asdasd@asdddasd.com";
  final String facebook = "asddasdasd_x";
  final String instagram = "asddasdasd_x";
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              AnimalInfos(
                image: Image.asset(
                  "lib/images/${ourAnimal.toLowerCase()}.png",
                  scale: 1.3,
                ),
                infoText: "$ourAnimal - $ourBreed",
