...
class SubmitLostAds extends StatefulWidget {
  const SubmitLostAds({super.key});

  @override
  _SubmitLostAdsState createState() => _SubmitLostAdsState();
}

class _SubmitLostAdsState extends State<SubmitLostAds> {
  // Formkey
  ...
  String? selectedBreed = "Scottish Fold";

  // Dropdown options
  List<String> animalOptions = ['Cat', 'Dog', 'Bird'];
  List<String> breedOptions = ['Scottish Fold', 'British Shorthair'];
